    ...
    <Container>
      <Content>
        <div>
          ...
          <p>이 약관은 엔디소프트 주식회사(이하 ”회사”)가 제공하는 임대형 인터넷신문 서비스(이하 “서비스”)의 이용조건 및 절차에 관한 사항을 규정함을 목적으로 합니다.</p>
          ...
          <ol class="privacy-list">
            ...
            <li>관리자 아이디(ID) : 고객의 식별과 서비스의 이용을 위하여 고객이 설정한 문자와 숫자의 조합을 말합니다.</li>
            <li>관리자 비밀번호 (PASSWORD) : 고객의 개인정보 및 권익보호를 위하여 고객이 설정한 문자와 숫자의 조합으로 고객의 인터넷신문 관리자 아이디(ID)와 함께 고객의 신원확인에 사용됩니다.</li>
            ...
            <li>미디어N : 콘텐츠 공급사로부터 제공된 기사와 사진을 고객이 전제할 수 있도록 제공하는 기사공유를 위한 부가 서비스를 말합니다.</li>
        ...
        <div class="privacy-group">
          ...
          <ol class="privacy-list">
            <li>회사는 서비스 종류, 서비스 내용, 가격 및 기타 서비스 관련 사항을 회사의 홈페이지(https://www.ndsoft.co.kr)를 통하여 게시하며, 고객은 게시된 내용을 기준으로 서비스 이용신청을 합니다.</li>
          ...
          <ol class="privacy-list">
            <li>이용신청은 고객이 이 약관에 동의하고 회사가 정한 신청양식을 인터넷에서 작성 후 신청하는 것으로 이루어지며, 회사는 고객에게 구비서류 제출을 요구할 수 있습니다. 이 이용약관에 대한 동의는 이용신청 시 회사 홈페이지의 “서비스 이용약관에 동의합니다” 항목에 체크함로써 의사표시를 합니다.</li>
            <li>고객은 이용신청 시 실명과 실제정보를 입력하여야 하며 이를 위반한 고객은 법적인 보호를 받을 수 없습니다.</li>
        ...
        <div class="privacy-group">
          ...
          <ol class="privacy-list">
            ...
            <li>고객은 회사가 발급한 관리자 아이디와 비밀번호로 인증한 후 게시판에 글을 남기는 방법으로 기술지원을 신청할 수 있으며 전화나 이메일 등 다른 방법은 허용하지 않습니다.</li>
            <li>고객은 기술 지원에 대한 작업 완료 후 24시간 이내에 처리결과를 검수하여 오류에 대한 재작업 요구를 할 수 있습니다.</li>
            <li>회사가 발급한 기술지원을 위한 관리자 아이디와 비밀번호를 고객이 분실 또는 유출하여 발생한 피해에 대해서 책임지지 않습니다.</li>
            <li>고객이 관리자 아이디와 비밀번호를 분실하여 확인 요청을 하는 경우 회사는 고객의 신분 확인을 위한 서류를 요청 할 수 있습니다.</li>
        ...
        <div class="privacy-group">
          ...
          <p><strong>제13조 (미디어N)</strong></p>
          <ol class="privacy-list">
            <li>회사는 고객의 다양한 콘텐츠 활용을 위한 기사 전제가 가능한 미디어N 을 부가 서비스로 제공합니다.</li>
            <li>고객은 미디어N 서비스 이용시 콘텐츠의 내용을 검수하여 이용할 의무가 있으며, 이를 이용하는 과정에서 발생할 수 있는 사고 및 피해에 대해 회사는 책임이 없습니다.</li>
          </ol>

          <p><strong>제14조 (네트워크 광고)</strong></p>
          <ol class="privacy-list">
            <li>회사는 고객의 수익증대를 목적으로 인터넷신문과 모바일웹 사이트에 네트워크 광고를 설치하여 제공 할 수 있습니다.</li>
            <li>고객은 네트워크 광고 설치를 희망하지 않는 경우, 회사에 광고의 교체 또는 삭제를 요청할 수 있습니다.</li>
            <li>회사는 고객이 더 많은 수익을 창출할 수 있도록 네트워크 광고 공급사를 추가하거나 교체할 수 있습니다.</li>
          </ol>
        </div>
        ...
        <div class="privacy-group">
          ...
          <ol class="privacy-list">
            ...
            <li>고객은 회사가 발급한 관리자 아이디(ID)와 비밀번호를 제3자에게 누출할 수 없으며, 누출로 발생하는 손해에 대한 책임은 고객에게 있습니다.</li>
          ...
          <p><strong>제17조 (도메인 관리)</strong></p>
          <ol class="privacy-list">
            <li>고객은 도메인 유지비 납입 일자에 대해서 철저히 관리하여 도메인 유지비를 납입일 이내에 납부하여야하며, 이를 이행하지 않아서 발생하는 문제는 고객의 책임입니다.</li>
            <li>회사는 고객의 신청에 의하여 도메인 연결 업무를 대행하고, 도메인 연결 후 등록정보 변경 및 도메인 유지비 납부 등의 도메인 관리는 고객의 책임입니다.</li>
            <li>회사는 고객의 도메인 관련사고를 예방하기 위하여 도메인 관리를 위한 편의를 제공하도록 노력합니다.</li>
          </ol>

          <p><strong>제18조 (지식 재산권의 귀속 및 침해 금지)</strong></p>
          <ol class="privacy-list">
        ...
        <div class="privacy-group">
          ...
          <p><strong>제26조 (해지 고객의 데이터)</strong></p>
          <ol class="privacy-list">
        ...
        <div class="privacy-group">
          ...
          <p><strong>제28조(이용요금의 알반원칙)</strong></p>
          <ol class="privacy-list">
            <li>서비스 이용요금의 세부 내역 및 그 변경사항은 제5조에 따라 회사의 홈페이지에 명기합니다.</li>
            <li>고객이 납부하여야 하는 서비스 이용 요금의 종류는 다음 각호와 같으며 선납제로 운영됩니다.
          ...
          <p><strong>제29조(이용요금의 납부)</strong></p>
          <ol class="privacy-list">
          ...
          <p><strong>제30조(이용요금의 정산)</strong></p>
          <ol class="privacy-list">
          ...
          <p><strong>제31조(연체요금 관리)</strong></p>
          <ol class="privacy-list">
        ...
        <div class="privacy-group">
          ...
          <p><strong>제35조 (손해배상의 책임)</strong></p>
          ...
          <p><strong>제36조(고객의 손해배상의 청구)</strong></p>
          <ol class="privacy-list">
        ...
        <div class="privacy-group">
          ...
          <ul class="privacy-list">
            <li>본 약관은 2015년 7월 15일 개정되었습니다. </li>
            <li>본 약관은 2015년 8월 01일 시행되었습니다.</li>
            <li>본 약관은 2017년 8월 31일 개정되었습니다. </li>
            <li>본 약관은 2017년 9월 15일 시행되었습니다. </li>
          </ul>
        </div>
      </Content>
    </Container>
